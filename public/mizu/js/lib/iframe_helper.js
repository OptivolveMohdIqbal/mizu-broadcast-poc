...
webphone_api.reject = function () {
  SendMessageToFrame("webphone_api.reject(19,3)");
};
...
webphone_api.setaudiodevice = function (dev, devicename, immediate, fromcode) {
  SendMessageToFrame(
...
webphone_api.setdevice = function (dev, devicename, immediate, fromcode) {
  SendMessageToFrame(
