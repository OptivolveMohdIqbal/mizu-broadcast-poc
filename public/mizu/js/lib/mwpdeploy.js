var mwpdeploy = (function () {
  function e(e) {
    o.debug && (console && console.log ? console.log(e) : alert(e));
  }
  function t(e, t) {
  ...
  var l = {
    ...
    s = (l.object.concat(l.core, l.i18n, l.events), l.applet.concat(l.core)),
    o = {
      debug: null,
      version: "20120801",
      ...
      testUsingMimeTypes: function (t) {
        ...
        for (var n = 0; n < navigator.mimeTypes.length; ++n) {
          var i = navigator.mimeTypes[n].type,
            a = i.match(
              /^application\/x-java-applet\x3Bversion=(1\.8|1\.7|1\.6|1\.5|1\.4\.2)$/,
            );
          if (null != a && this.compareVersions(a[1], t)) return !0;
        }
        return !1;
      },
      testUsingPluginsArray: function (e) {
        ...
        for (
          ...
          var i = navigator.plugins[n].description;
          if (-1 != i.search(/^Java Switchable Plug-in (Cocoa)/)) {
  ...
  if ((o.writePluginTag(), null == o.locale)) {
    ...
    if (null == u)
      try {
        u = navigator.systemLanguage;
      } catch (h) {}
    if (null == u)
      try {
        u = navigator.language;
      } catch (h) {}
    null != u && (u.replace("-", "_"), (o.locale = u));
  }
  return o;
})();
