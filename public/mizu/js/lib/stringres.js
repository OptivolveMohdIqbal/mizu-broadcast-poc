...
webphone_api.stringres = (function () {
  var StringResources = {
    ...
    np_install_msg:
      "Please launch the installer once download completes.<br>Click OK when install finished.",
    np_install_msg_lin:
    ...
    license_key_ack:
      "License key accepted and it will be verified later. We will not disturb you again if they key is valid",
    ...
    chrome_https:
      "For modern browsers we recommend to host the webphone on secure http (https), otherwise WebRTC will not work. \n(This message appears only in the demo versions)",
    webrtc_local_sipserver: "Local WebRTC server required!",
    chrome_https_reload:
      "For modern browsers WebRTC will only work from secure http (https). \n(This message appears only in the demo versions) \n\n Click OK to reload the page using mizu https proxy.",
    all_demo_msg:
      "Note: these messages are displayed only in demo version. Licensed builds will try to handle these situations automatically with no messsage popups",
    mac_app:
    ...
    srvaddr_help_cust:
      "VoIP service provider server address (ip address or domain name or DNS SRV record). You can also suffix a port number if the server is not on the default SIP port (5060). Example: yourserver.com:6000",
    ...
    automute__other_line: "On line change",
    automute__out_line: "Outgoing call and line change",
    automute__call_line: "Any call and line change",
    autohold__auto: "Auto",
    autohold__no: "No",
    autohold__incoming: "On incoming call",
    autohold__outgoing: "On outgoing call",
    autohold__both: "On incoming and outgoing calls",
    autohold__other_line: "On line change",
    autohold__out_line: "Outgoing call and line change",
    autohold__call_line: "Any call and line change",
    ...
    sett_comment_short_volumein: "Microphone input volume",
    ...
    sett_comment_short_volumeout: "Speaker output volume",

    sett_display_name_playtone: "Play Tones",
    sett_comment_playtone:
      "Play sound feedback on hangup/reject/error, call waiting, hold/resume, chat and more in the NS engine",
    sett_comment_short_playtone:
      "NS engine feedback tones on various events such as reject, call waiting or hold",

    playtone__default: "Default",
    playtone__no: "No",
    playtone__auto: "Auto",
    playtone__yes: "Yes",
    playtone__force: "Force",
...
*/
    ...
    webcallme_msg_es:
      "Envía este enlace a tus amigos y ellos podrán llamarte con un simple clic",
    warning_notstarted_es:
      "no se puede iniciar la llamada porque el teléfono aún no se inició",
    warning_notreg_es:
      "No se puede iniciar la llamada porque aún no se ha registrado",
    warning_msg_4_es:
      "Error al recuperar las configuraciones.<br>En la entrada del servidor de la página Configuración, ingrese el nombre de dominio o la dirección IP de su proveedor de VoIP",
    warning_msg_3_es: "Ingrese el nombre del contacto",
    warning_msg_2_es:
      "IP o nombre del dominio no soportado en esta versión. Introduzca nombre del servidor o ID aquí.",
    warning_msg_1_es:
      "Solo llamadas directas a SIP URIs son posibles si la dirección del servidor VoIP no está establecida",
    warning_feature_es:
      'debe obtener una licencia Pro para habilitar esta función.<br>Para activar la licencia, inicie sesión primero, luego seleccione "Licencia" en el menú.',
    ...
    videomode__askonce_es:
      "Vuelva a llamar cuando sea necesario (pregunte una vez)",
    videomode__alwaysask_es:
      "Vuelva a llamar cuando sea necesario (siempre pregunte)",
    ...
    username_err_es:
      "el nombre de usuario contiene caracteres especiales no admitidos, vuelva a escribir",
    username_es: "Usuario",
    usenative_title_es: "Usar aplicación nativa",
    usenative_option_webrtc_es:
      "ignorar e iniciar (webrtc) en el navegador web ahora mismo",
    usenative_option_native_es:
      "Recomendado: marcador nativo con mejor calidad",
    ...
    use_fast_ice__no_es:
      "No (establecido en 0 solo si su servidor necesita enrutar siempre los medios)",
    ...
    unlockadvancedsett_msg_es:
      "ingrese la contraseña para desbloquear la configuración avanzada",
    ...
    sync_message_es:
      "la sincronización solo funcionará después de que haya cargado los contactos desde el dispositivo móvil.",
    sync_failed_es: "error de sincronización",
    sync_contacts_started_es: "Sincronizando contactos...",
    switch_engine_es: "cambiar de motor",
    switch_confmessage_es:
      "para usar la conferencia, debe instalar NS -Service Plugin. Simplemente haga clic en Aceptar para continuar.",
    ...
    support_email_body_es:
      "Copie y pegue aquí el contenido de la ventana de registro:",
    ...
    smscode_instrucation_es:
      "Debería recibir su código de inicio de sesión ahora por SMS. Por favor, introduzca su código de inicio de sesión:",
    ...
    sett_display_name_submenu_sounddevicevolume_es:
      "Dispositivo de sonido y volumen...",
    ...
    sett_display_name_submenu_calldivert_advanced_es:
      "Configuración Avanzada...",
    sett_display_name_submenu_calldivert_es:
      "Configuración de desvío de llamadas...",
    sett_display_name_submenu_advanced_es: "Configuración Avanzada...",
    sett_display_name_storecallhistory_es:
      "almacenamiento del historial de llamadas",
    ...
    sett_display_name_settobasefunctionality_es:
      "Establecer como funcionalidad base",
    ...
    sett_display_name_keepdeviceawakeincall_es:
      "Dispositivo preparado para la llamadas entrantes",
    ...
    sett_display_name_incomingcallpopup_es:
    ...
    sett_display_name_enginepriority_ns_es:
      "prioridad del complemento de servicio",
    sett_display_name_enginepriority_nativedial_es:
      "Prioridad de marcador nativo",
    ...
    sett_display_name_enginepriority_accessnum_es:
      "prioridad del número de acceso",
    ...
    sett_display_name_displayaudiodevice_es:
      "mostrar siempre el dispositivo de audio",
    ...
    sett_display_name_cpualwayspartiallock_es:
      "CPU siempre parcialmente bloqueado",
    ...
    sett_display_name_callforwardonnoanswertimeout_es:
      "Desvío de llamada sin tiempo de espera de respuesta",
    sett_display_name_callforwardonnoanswer_es:
    ...
    sett_display_name_callback_accessnumber_es:
      "Número retorno de llamada (callback)",
    ...
    sett_display_name_autoanswer_forward_es:
      "Auto-respuesta, reenvío o ignorar",
    ...
    sett_display_name_alwaysallowlowcodec_es:
      "Permitir códec de banda estrecha",
    ...
    sett_comment_volumeout_es:
      "establece el volumen predeterminado del altavoz entre 0 y 100 %. 50 significa que no hay cambios de volumen.",
    sett_comment_volumein_es:
      "configura el volumen predeterminado del micrófono entre 0 y 100 %. 50 significa que no hay cambios de volumen.",
    sett_comment_voicerecording_es:
      "si está habilitado, todas las llamadas se grabarán",
    sett_comment_voicemailnum_es:
      "Establecer el número del buzón de voz que se utilizará si no se recibe automáticamente",
    sett_comment_videomode_es:
      "especifique cómo manejar las videollamadas entrantes",
    ...
    sett_comment_video_fps_es:
      "Ajuste del número de imágenes por segundo en el video, 0 valor por defecto",
    ...
    sett_comment_usetunneling_2_es:
      "use señalización y medios dentro del túnel encriptado.",
    sett_comment_usetunneling_1_es:
      "Útil en países bloqueados de VoIP y detrás de firewalls. Si necesita usar esta función para más de unas pocas llamadas, debe actualizar a MizuDroidPro, que incluye un servicio de tunelización ilimitado.",
    sett_comment_usetunneling_es:
      "use una capa de transporte encriptada y tunelizada (UDP, TCP o HTTP)",
    sett_comment_useroutingapi_es:
      "Utilice el API de enrutamiento por razones de compatibilidad. Algunos dispositivos -por lo general viejos- podrían necesitar de esto para la correcta manipulación del audio",
    sett_comment_username_es:
      "esto no se usará para la autenticación. Especifique su ID de usuario o extensión aquí si no es el mismo que el nombre de usuario para la configuración de autenticación. ¡Algunos servidores VoIP rechazarán si no es lo mismo con el nombre de usuario!",
    sett_comment_use_vp9_es: "usar el códec de video VP9",
    sett_comment_use_vp8_es: "usar el códec de video VP8",
    sett_comment_use_stun_es:
      "Cambie si tiene problemas relacionados con NAT (no puede registrarse, no puede llamar, no tiene problemas de voz)",
    ...
    sett_comment_use_fast_ice_es:
      'Negociaciones ICE rápidas (para enrutamiento p2p rtp).<br>Nota: si se establece en "Auto" o "Sí", entonces STUN no debe desactivarse',
    sett_comment_unlockphone_es:
      "Desactiva automáticamente el bloqueo de teclas del teléfono durante una llamada entrante",
    sett_comment_transport_es: "Seleccionar capa de transporte",
    sett_comment_transfwithreplace_es:
      "especifique si se debe usar reemplazar con la transferencia para que la llamada anterior (diálogo) no se desconecte sino que simplemente se reemplace. De esta manera, la parte A nunca se desconecta, solo se cambia la parte llamada. La parte A debe poder manejar el encabezado de reemplazo para esto.",
    sett_comment_transfertype_es: "Elegir el tipo de transferencia de llamada",
    sett_comment_theme_es: "Cambiar colores de piel",
    sett_comment_textmessaging_es:
      "especificar el método de mensajería de texto",
    sett_comment_telsearchkey_es: "establecer la clave api de tel.search.ch",
    sett_comment_techprefix_es:
      "Añadir el prefijo a todos los números llamados",
    sett_comment_submenu_video_es: "Configuración relacionada con el video",
    sett_comment_submenu_sounddevicevolume_es:
      "Reproducción de sonido y grabación",
    sett_comment_submenu_sipsettings_es: "Configuración relacionada con el SIP",
    sett_comment_submenu_screenshare_es:
      "especificar la configuración del escritorio remoto",
    ...
    sett_comment_submenu_integrate_es:
      "al marcar con un marcador nativo, se le preguntará si desea usar SIP o móvil",
    ...
    sett_comment_storecallhistory_es:
      "Especifique dónde desea almacenar el histórico de llamadas",
    sett_comment_startwithos_es: "Iniciar cuando se inicia Windows",
    sett_comment_startonboot_es:
      "escuchar siempre las llamadas entrantes (el servicio se ejecutará en segundo plano para habilitar las llamadas entrantes)",
    sett_comment_sstop_es:
      "coloque la ventana para compartir pantalla en la parte superior",
    sett_comment_ssscroll_es:
      "Permitir controles de desplazamiento de ventana para compartir pantalla",
    sett_comment_ssquality_es: "calidad de escritorio remoto",
    sett_comment_sscontrol_es:
      "permite el control remoto para compartir la pantalla (de lo contrario, solo ver)",
    sett_comment_speakerphoneplayer_es:
      "Selecciona el canal de altavoz. Debería solo cambiarse en dispositivos especiales o si se tiene requerimientos especiales o si la configuración automática no es la elegida",
    sett_comment_speakerphoneoutput_es:
      "Selecciona el dispositivo de salida cuando se conmuta al altavoz",
    ...
    sett_comment_silencesupress_es:
      "no transmita contenido multimedia cuando no hable. Habilite solo si su ancho de banda es realmente bajo.",
    sett_comment_signalingport_es:
      "especifique el puerto de señalización de la dirección IP local que se usará (el valor predeterminado es un puerto estable inicializado con un valor aleatorio. Esto no tiene nada que ver con el puerto SIP del servidor, que generalmente es 5060)",
    sett_comment_short_voicemailnum_es:
      "Establecer el número de acceso al buzón de voz",
    sett_comment_short_video_bandwidth_es:
      "establece el ancho de banda del video",
    sett_comment_short_usetunneling_es: "Usa transporte cifrado alternativo",
    sett_comment_short_username_es:
      "puede configurar un nombre de usuario diferente aquí para mostrar un número",
    sett_comment_short_use_stun_es:
      "Permitir el descubrimiento externo de direcciones",
    sett_comment_short_transport_es: "Seleccionar capa de transporte",
    sett_comment_short_transfwithreplace_es:
      "especifique si se debe usar reemplazar con la transferencia para que la llamada anterior (diálogo) no se desconecte sino que simplemente se reemplace.",
    ...
    sett_comment_short_signalingport_es:
      "opcionalmente, especifique el puerto de señalización local para usar",
    sett_comment_short_serveraddress_user_es: "dirección del servidor VoIP",
    sett_comment_short_screenrotation_es:
      "Controla la orientación de la pantalla",
    sett_comment_short_savetocontacts_es:
      "Añadir nuevo contacto a la lista de contactos",
    sett_comment_short_rtpport_es: "Especificar puerto RTP local",
    sett_comment_short_registerinterval_es:
      "(Re)registrar intervalo de tiempo en segundos",
    sett_comment_short_register_es:
      "Habilitar / Deshabilitar el registro contra el dominio SIP",
    sett_comment_short_realm_es:
      "establezca el dominio SIP si la detección automática predeterminada no es correcta",
    ...
    sett_comment_short_proximitysensor_es:
      "Desconecta la pantalla cuando se acerca la oreja",
    ...
    sett_comment_short_forcewifi_es:
      "Mantiene el WiFi levantado para gestionar llamadas entrantes",
    sett_comment_short_focusaudio_es: "Priorizar el audio en llamadas VoIP",
    sett_comment_short_extraoption_es:
      "establezca cualquier parámetro personalizado",
    ...
    sett_comment_short_displaynotification_es:
      "Muestra notificaciones en la barra de notificaciones del teléfono",
    ...
    sett_comment_short_cpualwayspartiallock_es:
      "Mantiene un bloqueo parcial en la CPU para prevenir hibernación.",
    sett_comment_short_codecframecount_es:
      "Carga útil de codec en un paquete UDP.",
    sett_comment_short_changesptoring_es:
      "Trata la respuesta de progreso de sesión (183) como tono de llamada (180)",
    sett_comment_short_cfgcpuspeed_es:
      "Las características se selecciona automáticamente basándose en la velocidad de CPU",
    sett_comment_short_callforwardonreject_es:
      "Desvío de llamadas en caso de rechazo",
    sett_comment_short_callbacknumber_es:
      "Número de teléfono de retorno de llamada (callback)",
    sett_comment_short_callback_es: "En caso de servidor HTTP API",
    sett_comment_short_call_access_es:
      "Número de acceso para llamar desde la red de operador móvil",
    sett_comment_short_audiobufferlength_es:
      "Ajuste avanzado para el tamaño del buffer de reproducción de audio",
    sett_comment_share_location_es:
      "compartir los detalles de mi ubicación con los contactos.",
    sett_comment_settobasefunctionality_es: "Utilizada en desarrollo",
    sett_comment_setqos_es:
      "Establece la clase de tráfico o octeto de tipo de servicio en las cabeceras IP para paquetes UDP",
    sett_comment_setfinalcodec_es:
      "Solución para la negociación con múltiples codecs",
    sett_comment_serveraddress_user_operator_es:
      "Introduzca el código de operador",
    sett_comment_serveraddress_user_gmsdialer_es:
      "Introduzca el código de operador",
    sett_comment_serveraddress_user_es:
      "Ingrese la dirección del servidor (dominio o IP: puerto), nombre de marca o código de operación aquí",
    sett_comment_sendrtponmuted_es:
      "Envía RTP incluso en silencio activado (paquetes puestos a cero). Establece verdadero solo si el servidor funciona mal cuando se suprime RTP",
    ...
    sett_comment_savetocontacts_es:
      "Para añadir un número llamado a su lista de contactos",
    sett_comment_rtpport_es:
      "Especificar el puerto local RTP base (por defecto es un puerto base constante inicializado con un valor aleatorio)",
    sett_comment_ringtone_es:
      "Cambia el tono de llamada para llamadas entrantes",
    sett_comment_ringtimeout_es:
      "Tiempo máximo permitido en segundos que sonará el tono de llamada. Por defecto 90 segundos.",
    sett_comment_reset_settings_es:
      "Restaura la configuración a los valores por defecto",
    sett_comment_rejectonvoipbusy_es:
      "Establece el comportamiento si hay todavía una llamada VoIP en progreso",
    sett_comment_rejectonphonebusy_es:
      "establezca el comportamiento si ya hay una llamada telefónica nativa en curso",
    sett_comment_registerinterval_es:
      "(Re)registrar intervalo de tiempo en segundos",
    sett_comment_register_es:
      "Registro de dominio. Esto siempre es necesario para recibir llamadas entrantes y algunos proveedores requieren también permitir llamadas salientes.",
    sett_comment_realm_es:
      "establezca el reino SIP si no es el mismo con la dirección del servidor o el dominio",
    sett_comment_ratingrequest_es: "Petición de clasificación HTTP",
    sett_comment_proxyaddress_es:
      "dirección de proxy SIP saliente. Déjalo vacío si no tienes un proxy sin estado/de salida",
    sett_comment_proximitysensor_es:
      "Desconecta la pantalla durante la llamada. Esta característica se desconecta por defecto porque la mayor parte de los dispositivos tienen problemas para conectar",
    sett_comment_profilestatustext_es:
      "puede ingresar cualquier texto aquí (por ejemplo, enlace a su página de Facebook).",
    sett_comment_profilepicture_es: "configura tu foto de perfil.",
    sett_comment_presencestatus_es: "Cambiar mi estado de presencia.",
    sett_comment_prack_es:
      "Soporte para paquetes 100rel. Debe ser habilitado sólo si el servidor así lo requiere",
    sett_comment_plc_es:
      "Ocultación de pérdida de paquetes. Ayuda a mejorar la calidad de la llamada causada por pérdida de paquetes en redes de baja calidad",
    sett_comment_playring_es:
      "Generar el tono de llamada para las llamadas entrantes y salientes",
    sett_comment_password_es: "Introducir la contraseña de su cuenta SIP",
    sett_comment_p2p_es: "Petición http teléfono a teléfono",
    sett_comment_nsupgrademode_es:
      "establece cómo/cuándo actualizar el motor NS.",
    sett_comment_normalizenumber_es:
      "eliminar caracteres especiales de los números marcados",
    sett_comment_natopenpackets_es:
      "Paquetes UDP enviado a un dispositivo NAT(cambiar si tiene problemas con la NAT)",
    sett_comment_nativefilterblock_es:
      "No gestiona las llamadas nativas si el número empieza con",
    sett_comment_nativefilterallow_es:
      "Gestiona las llamadas nativas si el número empieza con",
    sett_comment_multiplecalls_es:
      "Permitir múltiples llamadas / conferencias (CPU de gama baja no es capaz gestionarlas)",
    sett_comment_moresettings_es: "Mostrar más configuraciones",
    sett_comment_mediaencryption_es:
      "establecer el método de cifrado de medios",
    sett_comment_loglevel_dbg_es:
      "Establece el nivel de detalle de logs cuando las trazas están activadas",
    sett_comment_loglevel_es:
      "Guarda las trazas en un fichero para enviarlo al soporte técnico",
    sett_comment_localip_es:
      "Opcionalmente, especifique la dirección IP de señalización local para usar",
    sett_comment_language_es: "establecer el idioma de la aplicación",
    sett_comment_keeprecfiles_es:
      "mantener grabaciones de llamadas de los últimos días especificados",
    sett_comment_keepdeviceawakeincall_es:
      "Dispositivo operativo durante las llamadas",
    sett_comment_keepaliveival_es:
      "intervalo de envío de paquetes NAT keep-alive en milisegundos. Establecer en 0 para deshabilitar.",
    sett_comment_keepalive_es:
      "enviará un paquete corto en el intervalo de tiempo especificado (segundos) para abrir y mantener abierto su dispositivo NAT (enrutador) para habilitar las llamadas entrantes y otras notificaciones",
    sett_comment_jittersize_es:
      "El buffer jitter se usa para una reproducción suave con ancho de banda variable.  El tamaño se calcula dinámicamente, pero su comportamiento se puede modificar con este ajuste",
    sett_comment_integrateifwifionly_es:
      "Integrar con el marcador nativo solo en conexiones Wifi",
    sett_comment_incomingcallpopup_es:
      "si mostrar una ventana emergente sobre las llamadas entrantes.",
    sett_comment_incomingcallalert_es:
      "Selecciona el canal de reproducción del timbre. Debería solo cambiarse en dispositivos especiales o si se tiene requerimientos especiales o si la configuración automática no es la elegida",
    sett_comment_importonlywithnum_es:
      "si está marcado, omitirá los contactos sin un número de teléfono",
    sett_comment_icetimeout_es:
      "establece el tiempo de espera de ICE en milisegundos",
    ...
    sett_comment_hardwaremedia_es:
      "Utilizar las mejoras de los recursos hardware para AEC o eliminar el ruido. Esto puede añadir un ligero retardo para las transmisiones de audio",
    sett_comment_forcewifi_es:
      "(Re)Activa y escanea WiFi en el arranque, nueva llamada o pérdida de conexión(Incluso sin esta configuración, WiFi será el preferido cuando esté disponible)",
    sett_comment_focusaudio_es:
      "Prioriza el audio de la llamada VoIP(esto podría reducir el volumen de otros flujos de audio, mientras que está hablando sobre VoIP)",
    sett_comment_flash_es: "Flash en llamada entrante o chat",
    sett_comment_filters_es:
      "Agregar reglas de reescritura de número de destino (agregar/eliminar/reescribir prefijo)",
    sett_comment_extraoption_es:
      "establezca cualquier parámetro personalizado en una lista de pares clave-valor, separados por punto y coma.<br>Ej: nombre para mostrar = John;",
    sett_comment_entersettings_es: "Mostrar configuración",
    sett_comment_enginepriority_webrtc_es:
      "establecer la prioridad del motor WebRTC",
    sett_comment_enginepriority_p2p_es:
      "establece la prioridad del motor de teléfono a teléfono",
    sett_comment_enginepriority_ns_es:
      "establecer la prioridad del motor del complemento de servicio",
    sett_comment_enginepriority_nativedial_es:
      "establecer la prioridad del motor de marcador nativo",
    sett_comment_enginepriority_java_es:
      "establecer la prioridad del motor del applet de Java",
    sett_comment_enginepriority_flash_es:
      "establecer la prioridad del motor flash",
    sett_comment_enginepriority_app_es:
      "establecer la prioridad del motor de la aplicación",
    sett_comment_enginepriority_accessnum_es:
      "establecer la prioridad del motor del número de acceso",
    sett_comment_encryptionport_es:
      "Puerto base del servidor utilizado para transporte cifrado",
    sett_comment_enablepush_es:
      "Escuche las llamadas entrantes también cuando el teléfono web no está abierto",
    sett_comment_enableblf_es: "campo de luz de ocupado",
    sett_comment_enableaudio_es: "Utilizada únicamente en pruebas",
    sett_comment_email_es:
      "Dirección de correo electrónico (útil para soporte técnico)",
    sett_comment_earlymedia_es:
      "Comenzar a enviar audio una vez se recibe session progress",
    sett_comment_dtmfmode_es:
      "Elegir DTMF (marcación por tonos) como método de envío",
    sett_comment_dropsameoldcall_es:
      "Desconectar la llamada si se recibe la misma llamada varias veces",
    sett_comment_doublesendrtp_es:
      "Podría mejorar la calidad de audio en algunas circunstancias, pero incrementará  la cantidad de datos enviada",
    sett_comment_displayvolumecontrols_es:
      "mostrar siempre los controles de volumen durante una llamada",
    sett_comment_displaynotification_es:
      "Muestra notificaciones en la barra de notificaciones del teléfono (normalmente en la esquina superior del teléfono)",
    sett_comment_displayname_es:
      "especifique el nombre para mostrar. Esta es una configuración opcional y debe ser su nombre completo",
    sett_comment_displayaudiodevice_es:
      "mostrar siempre el dispositivo de audio durante una llamada",
    sett_comment_disablewbforpstn_es:
      "Desactivar codecs de audio de banda ancha para llamadas a números móviles y fijos (banda ancha solo para llamadas de IP a IP)",
    sett_comment_dialerintegration_es:
      "al marcar con un marcador nativo, se le preguntará si desea usar SIP o móvil",
    sett_comment_devtest_es: "Usado solo para desarrollo",
    sett_comment_denoise_es:
      "elimina el ruido de la conversación (como el ruido de fondo o el ruido generado por el micrófono).",
    sett_comment_defmute_es:
      "Especifica como silenciar las llamadas cuando se presiona el botón de silencio",
    sett_comment_customsipheader_es:
      "Establece una cabecera SIP personalizada (una línea en la señalización SIP) que será enviada con todos los mensajes SIP (configuración avanzada)",
    sett_comment_creditrequest_es: "Petición de balanceo HTTP",
    sett_comment_cpualwayspartiallock_es:
      "Mantiene el procesador del dispositivo siempre levantado. Configurarlo solo si de otra forma se pierde los registros y no se reciben llamadas entrantes",
    sett_comment_conferencetype_es:
      "habilitar/deshabilitar la función de sala de conferencias",
    sett_comment_codecframecount_es:
      "número de cargas útiles de códec en un paquete UDP/RTP. Los valores más altos requerirán menos ancho de banda pero más retrasos. Valores inusuales (por encima de 4) pueden causar incompatibilidad con su proveedor.",
    sett_comment_codec_es: "Seleccione el códec preferido",
    sett_comment_chatsms_es: "Establece el método de mensajería",
    sett_comment_changesptoring_es:
      "Trata la respuesta de progreso de sesión (183) como tono de llamada (180). Esto se podría requerir si el proveedor de servicio no envía tono de llamada ni audio",
    sett_comment_cfgvideo_es: "Habilitar videollamada",
    sett_comment_cfgnetworkspeed_es:
      "ayuda a elegir el mejor códec y mejoras multimedia para sus llamadas.",
    sett_comment_cfgcpuspeed_es:
      "Características como AEC o codec se activan/desactivan en base a la velocidad de procesador del dispositivo",
    sett_comment_capabilityrequest_es:
      "Si se establece, enviará un mensaje de solicitud de capacidad (OPTIONS) al servidor SIP en el arranque",
    sett_comment_calltransferalways_es:
      "establezca el número de transferencia de llamadas donde se deben transferir todas las llamadas",
    sett_comment_calltimeout_es:
      "tiempo máximo de conversación permitido en segundos. El valor predeterminado es 10800 segundos, lo que significa 3 horas",
    sett_comment_callforwardonreject_es: "Reenviar llamada si es rechazada",
    sett_comment_callforwardonnoanswertimeout_es:
      "demora en segundos antes de que la llamada se desvíe si no responde",
    sett_comment_callforwardonnoanswer_es:
      "establecer el número de desvío de llamadas, las llamadas deben desviarse si no hay respuesta",
    sett_comment_callforwardonbusy_es:
      "establece el número de desvío de llamadas utilizado cuando la llamada se rechaza por ocupado o para el desvío automático",
    sett_comment_callforwardalways_es:
      "establece el número de desvío de llamadas al que se deben desviar todas las llamadas",
    sett_comment_callbacknumber_es:
      "Número de teléfono de retorno de llamada (callback). Algunos proveedores de servicio VoIP ofrecen este número al que se puede llamar, para recibir llamadas desde el servidor IVR",
    sett_comment_callback_mode_es: "Selecciona cuando usar el modo rellamada",
    sett_comment_callback_accessnumber_es:
      "Número de teléfono de retorno de llamada (callback). Algunos proveedores de servicio VoIP ofrecen este número al que se puede llamar, para recibir llamadas desde el servidor IVR",
    sett_comment_callback_es: "Petición HTTP de devolución de llamada",
    sett_comment_call_access_es:
      "Número de acceso de IVR para llamar desde la red de operador móvil",
    ...
    sett_comment_autousebluetooth_es:
      "Uso Bluetooth automáticamente cuando detecte dispositivos",
    sett_comment_automute_es:
      "Especifica que las nuevas llamadas deben ser silenciadas si hay otras llamadas",
    sett_comment_autoignore_es:
      "Ignora automáticamente todas las llamadas entrantes",
    sett_comment_autohold_es:
      "Especifica que las nuevas llamadas deben quedar en espera si existen llamadas",
    sett_comment_autoanswer_forward_es:
      "Encargarse automáticamente de TODAS las llamadas entrantes",
    sett_comment_autoaccept_es:
      "aceptar automáticamente todas las llamadas entrantes (respuesta automática)",
    sett_comment_audiorecorder_es:
      "Selecciona el canal de grabación de audio para las llamadas. Debería solo cambiarse en dispositivos especiales o si se tiene requerimientos especiales o si la configuración automática no es la elegida",
    sett_comment_audioplayer_es:
      "Selecciona el canal de reproducción de audio para llamadas. Debería solo cambiarse en dispositivos especiales o si se tiene requerimientos especiales o si la configuración automática no es la elegida",
    sett_comment_audiodevices_es:
      "la configuración del dispositivo de audio estará disponible en el menú de la página del teclado una vez que inicie sesión",
    sett_comment_audiobufferlength_es:
      "-1 significa automático. Los valores válidos están entre 160 y 16000. Configuración experta.",
    sett_comment_audio_bandwidth_es: "establecer el ancho de banda de audio",
    sett_comment_androidspeaker_es:
      "especifique el dispositivo de reproducción predeterminado en Android",
    sett_comment_alwaysallowlowcodec_es:
      "habilitar siempre el códec básico de banda estrecha",
    sett_comment_agc_es:
      "Control automático de ganancia. Controlará el volumen automáticamente.",
    sett_comment_aec_es:
      "cancelación de eco acústico. Actívelo si sus compañeros escuchan su eco.",
    sett_comment_advancedsettings_es:
      "Mostrar opciones Avanzadas de Configuración",
    sett_comment_advancedloginsettings2_es:
      "configuración relacionada con el inicio de sesión SIP",
    sett_comment_advancedloginsettings_es:
      "muestra la configuración de inicio de sesión avanzada",
    sett_comment_accounts_es:
      "Administre múltiples cuentas SIP. ¡Use esto solo si desea configurar más de una cuenta!",
    ...
    serviceengine_msg_es:
      "instale el complemento de servicio para una mejor experiencia",
    service_update_es:
      "una nueva versión del motor NS VoIP está disponible. <br>Descargue e inicie el ejecutable para actualizar.",
    ...
    reset_settings_msg2_es:
      "la configuración se restableció a los valores predeterminados.",
    reset_settings_msg_es: "¿Seguro que quiere restablecer la configuración?",
    request_permission2_title_es: "Permitir permiso",
    request_permission2_es:
      "permite que [BRANDNAME] use su micrófono y/o cámara. <br>Es posible que haya bloqueado antes el acceso a los dispositivos de micrófono y/o cámara. En este caso, vaya a la configuración de su navegador y habilite el acceso para este dominio.",
    request_permission_es:
      "Esperando permiso. Presione el botón Permitir/Compartir en su navegador. Haga clic en el icono webrtc/micrófono/cámara/rojo si no ve el cuadro de diálogo.",
    register__yes_es: "Si",
    register__no_es: "No",
    ...
    proversion_content_text_es:
      "actualice a la versión Pro para uso comercial y funciones adicionales como el códec G.729 y otros.",
    ...
    password_err_es:
      "la contraseña contiene caracteres especiales no admitidos, vuelva a escribir",
    password_es: "Clave",
    pager_es: "Busca",
    ...
    other_es: "Otro",
    only_webrtc_engine2_es:
      "solo el motor WebRTC está disponible en su navegador, pero está deshabilitado en el teléfono web. Póngase en contacto con su proveedor de servicios.",
    only_webrtc_engine1_es:
      "solo el motor WebRTC está disponible en su navegador, pero está deshabilitado en el teléfono web con el parámetro enginepriority_webrtc",
    only_ns_engine4_es:
      "solo el motor Java VoIP está habilitado, pero no está disponible en su navegador. Utilice un navegador compatible con el applet de Java.",
    only_ns_engine3_es:
      "solo el motor Java VoIP está habilitado, pero no está disponible en su navegador. Utilice un navegador compatible con el subprograma Java, como Internet Explorer.",
    only_ns_engine2_es:
      "solo el motor de complemento de servicio está disponible en su navegador, pero está deshabilitado en el teléfono web. Póngase en contacto con su proveedor de servicios.",
    only_ns_engine1_es:
      "solo el motor del complemento de servicio está disponible en su navegador, pero está deshabilitado en el teléfono web con el parámetro enginepriority_ns",
    only_app_engine2_es:
      "solo el motor de la aplicación está disponible en su navegador, pero está deshabilitado en el teléfono web. Póngase en contacto con su proveedor de servicios.",
    only_app_engine1_es:
      "solo el motor de la aplicación está disponible en su navegador, pero está deshabilitado en el teléfono web con el parámetro enginepriority_app",
    ...
    np_successfully_installed_es:
      "el complemento de servicio se instaló correctamente.",
    np_popup_title_es: "Complemento de servicio",
    np_popup_msg_es:
      "debe instalar el complemento de servicio para que funcione el softphone.",
    ...
    np_install_msg_lin_es:
      "descargue, extraiga (descomprima) y ejecute el instalador <br>(puede iniciar el archivo .run desde la consola de su terminal).",
    np_install_msg_es:
      "Inicie el instalador una vez descargado. <br>Haga clic en Aceptar cuando finalice la instalación.",
    ...
    noaccounts_es:
      "Sin cuentas. Haga clic en el botón Más para agregar cuentas",
    no_history_es: "Historial de Llamadas Vacío.",
    no_contacts_2_es:
      'O use la opción de menú "Sincronizar contacto" para importar contactos desde su teléfono móvil.<br>(La sincronización funcionará solo después de cargar los contactos desde el dispositivo móvil)',
    no_contacts_1_es:
      'para crear contactos, seleccione "Nuevo contacto" en el menú.',
    ...
    me_es: "Yo",
    mac_app_es:
      "No hay motores disponibles en su entorno. Póngase en contacto con su proveedor de servicios.",
    logview_title_es: "Registros",
    logview_msg_es:
      "Es posible que la página no esté disponible durante unos segundos. Vuelva a cargar la página si no pasa nada.",
    logview_help_es:
      "Copie el contenido de la ventana de registros y envíelo por correo electrónico a:",
    log_email_es:
      "Su dirección de correo electrónico (útil para cualquier soporte técnico).",
    ...
    java_install_es:
      "haga clic en Aceptar para comenzar a descargar Java. <br>Vuelva a iniciar sesión una vez que haya terminado de instalarlo.",
    java_freeze_ff_es:
      'después de haber aceptado "Ejecutar esta aplicación",\nHaga clic en Aceptar para continuar',
    ...
    incomingcallpopup__auto_es:
      "Auto (mostrar solo si la ventana del navegador no está en primer plano/enfocada)",
    incomingcallpopup__always_es: "Forzar siempre desde todos los motores",
    in_hold_es: "(Pausa)",
    importonlywithnum__yes_es:
      "Sí (importar solo usuarios con número de teléfono)",
    importonlywithnum__no_es:
      "No (importar todos los usuarios incluso sin un número de teléfono válido)",
    ie_update_es:
      "esta aplicación requiere una versión superior de Internet Explorer. ¿Quieres descargar y actualizar?",
    home_es: "Casa",
    ...
    hint_speedtest_es:
      "pruebe el ancho de banda de su conexión a Internet, la pérdida de paquetes y la latencia",
    ...
    hint_phone_number_es:
      "ingrese aquí el número de teléfono, el nombre de usuario de la cuenta SIP o el URI SIP",
    ...
    hint_menu_es: "Menú",
    hint_integration_es:
      "agregue la funcionalidad de hacer clic para llamar al convertir números en enlaces en los que se puede hacer clic",
    hint_int_outlook_es:
      "Instale el complemento de clic para llamar de Outlook",
    ...
    hint_accept_hold_es:
      "poner la llamada anterior en espera y aceptar la nueva",
    ...
    filter_warning_es:
      'Al menos se debe ingresar el campo "Comenzar con" o "Reemplazar con".',
    ...
    fcm_perm_message_es:
      "se deniega el permiso para las notificaciones automáticas",
    ...
    err_msg_4_es:
      "número de teléfono, URI de SIP o nombre de usuario no válidos",
    err_msg_3_es:
      "ERROR, ingrese un número de teléfono o SIP URI o nombre de usuario",
    err_msg_22_es:
      "no se puede recuperar la configuración. Vuelva a intentarlo más tarde.",
    ...
    err_flash_local_es:
      "el motor Flash funcionará solo si se inicia desde un servidor web, no desde un sistema de archivos local",
    ...
    earlymedia__auto_es:
      "Automático (abrirá el audio antes si la banda ancha está habilitada para verificar si es compatible)",
    ...
    dtmfmode_op_4_es:
      "NTE (Eventos telefónicos con nombre como se especifica en RFC2833 y RFC 4733)",
    dtmfmode_op_3_es: "INFO + NTE",
    dtmfmode_op_2_es:
      "Automático (suposición automática a partir de capacidades anunciadas por pares)",
    dtmfmode_op_1_es: "método SIP INFO",
    dtmfmode_op_0_es: "Deshabilitado",
    dropsameoldcall__reqvideo_es: "Sí cuando se solicita y video",
    dropsameoldcall__requested_es:
      "cuando se solicita (si se recibió el encabezado del sorbo)",
    ...
    contact_no_nunber_es:
      "ingrese un número de teléfono, nombre de usuario o SIP URI",
    contact_name_es: "Nombre",
    contact_delete_msg_es: "¿Seguro que quiere borrar este contacto?",
    contact_delete_all_msg_es:
      "¿Está seguro de que desea eliminar todos los contactos? <br>¡Esto eliminará permanentemente toda la lista de contactos!",
    ...
    conferencetype__cr_msg_ref_es:
      "salas de conferencias a través de SIP MESSAGE y REFER",
    ...
    chrome_local_webrtc_audio_es:
      "WebRTC no tiene permiso para acceder a dispositivos de audio desde el sistema de archivos local en los navegadores Chrome y Opera. \nEl teléfono web debe estar alojado en un servidor web seguro (HTTPS) para poder realizar/recibir llamadas mediante WebRTC.",
    chrome_local_alert_es:
      "el motor WebRTC incorporado en el teléfono web no funcionará desde el sistema de archivos local en los navegadores Google Chrome u Opera (solo en HTTPS, desde servidores web con certificado SSL válido).\nEn estas circunstancias, el teléfono web se verá obligado a usar el NS u otros motores si están disponibles. Puede usar Firefox si desea probar el motor WebRTC del teléfono web cuando se inicia desde el sistema de archivos local.",
    chrome_https_reload_es:
      "para Chrome, Opera y Firefox versión 68 y superior, WebRTC solo funcionará desde http seguro (https). \n\n Haga clic en Aceptar para volver a cargar la página usando el proxy https de mizu.",
    chrome_https_es:
      "para Chrome, Opera y Firefox versión 68 y superior, recomendamos alojar el teléfono web en http seguro (https), de lo contrario, WebRTC no funcionará.",
    chrome_ext_install_title_es: "instalar la extensión de Chrome",
    chrome_ext_install_es:
      "Antes de usar Compartir pantalla, se debe instalar la extensión de Chrome del siguiente enlace.",
    chrome_ext_enable_title_es: "habilitar la extensión de Chrome",
    chrome_ext_enable_es:
      "haga clic en el enlace a continuación y habilite la extensión de Chrome Captura de pantalla",
    ...
    ce_native_ios_safari_es:
      "Su navegador no es compatible con WebRTC. Utilice la aplicación nativa.",
    ce_native_ios_not_safari_es:
      "Su navegador no es compatible con WebRTC. Cambie al navegador Safari o use la aplicación nativa.",
    ce_native_ios_es: "Su navegador no es compatible con WebRTC.",
    ce_native_android_es: "Usar aplicación nativa",
    ce_installnativeplugin_es:
      "instala [NATIVE_PLUGIN] para disfrutar de la mejor experiencia",
    ce_dontask_es: "No volver a preguntar",
    ce_browser_install_es: "Instalar",
    ce_browser_alternate_es: "navegador alternativo",
    ce_ask_user_es:
      "Parece que el motor [MOTOR SELECCIONADO] no funciona. ¿Cambiar a [RECOMENDADO]?",
    ...
    callreceiver__enablewhilerunning_es:
      "habilite las llamadas entrantes (mientras la aplicación se está ejecutando, sin escucha de fondo)",
    callreceiver__enablebackgroud_es:
      "habilitar también llamadas en segundo plano",
    callreceiver__auto_es: "Auto",
    callhistory_es: "Historial de Llamadas",
    callforward_title_es: "Desviar llamada",
    callback_src_es:
      "ingrese su número de teléfono móvil <br>(comenzando con el código de país)",
    callback_es: "Devolver Llamada",
    call_from_es: "Llamada perdida",
    call_forward_warn_es:
      "el desvío de llamadas funcionará solo si el par remoto tiene soporte para ello.",
    ...
    app_en_warning_short_es:
      "el navegador no tiene soporte de VoIP integrado o de complemento.",
    app_en_warning_es:
      "Su navegador no tiene ningún soporte de VoIP incorporado o de complemento. <br>Iniciando cliente de VoIP nativo...",
    app_en_message3_es:
      "no se puede acceder a su servidor VoIP a través de WebRTC o no está configurado. ¿Iniciar aplicación nativa?",
    app_en_message2_es:
      "VoIP no es compatible con su navegador. ¿Lanzar aplicación nativa?",
    app_en_message_es:
      "VoIP no es compatible con su navegador. Lanzará la aplicación nativa. (este mensaje no se mostrará en la versión de producción).",
    androidspeaker__ignore_es: "No cambiar",
    androidspeaker__guess_es: "Invitado automático",
    androidspeaker__def_es: "Por defecto",
    androidspeaker__before_fcall_es:
      "apagar el altavoz antes de la primera llamada",
    androidspeaker__atstart_es: "apagar el altavoz al inicio",
    androidspeaker__after_fcall_es:
      "apagar el altavoz después de la primera llamada",
    ...
    allowmedia_general_es:
      "necesita acceso a su micrófono.<br>Para otorgar acceso, haga clic en el icono de sonido/webrtc/micrófono/cámara/rojo en su navegador y seleccione Permitir o Compartir, luego vuelva a realizar la llamada.",
    all_demo_msg_es:
      "Nota: estos mensajes se muestran solo en la versión de demostración, en la versión final, estas situaciones se manejan automáticamente",
    agc__guess_es: "Guess",
    agc__for_redcording_es: "solo para grabar",
    agc__disabled_es: "Deshabilitado",
    agc__both_for_recording_and_playback_es:
      "tanto para reproducción como para grabación",
    ...
    addaccount_msg_es:
      "Complete los siguientes detalles para crear una nueva cuenta",
    ...
    add_to_home_msg_es:
      'puede crear un acceso directo en su pantalla de inicio a [MARCA]. Toca el ícono de Menú/Barra en la esquina superior derecha de tu navegador, luego toca \"Agregar a la pantalla de inicio\"',
    ...
    accounts_instructions2_es:
      "la cuenta seleccionada será la cuenta principal para las llamadas salientes. Las llamadas entrantes se pueden recibir en todas las cuentas.",
    accounts_instructions1_es:
      "administrar cuentas o establecer una cuenta principal.",
    accounts_hint_user_es: "cuenta VoIP del usuario",
    accounts_hint_server_es:
      "dirección IP del Servidor SIP o nombre de dominio  [:puerto]",
    accounts_hint_regival_es: "(Re)registrar intervalo de tiempo en segundos",
    accounts_hint_realm_es:
      "parámetro opcional para configurar el reino SIP si no es el mismo con la dirección del servidor o el dominio",
    accounts_hint_proxy_es: "Dirección del proxy saliente",
    accounts_hint_password_es: "Contraseña de la cuenta VoIP",
    accounts_hint_displayname_es:
      "Su nombre completo se mostrará en el lado llamado",
    accounts_hint_callerid_es:
      "Podría establecerse un usuario distinto para utilizarlo en una pantalla",
    ...
    if (lang.length > 0) {
      if (lang.length > 2) {
        if (lang.indexOf("-") > 0) langshort = lang.substr(0, lan.indexOf("-"));
          ...
          langshort = lang.substr(0, lan.indexOf("_"));
        ...
        if (langshort.length > 0) {
          ...
          if (langshort.length > 0) {
            if (
              (typeof StringResources["menu_call_" + langshort] !==
                "undefined" &&
                StringResources["menu_call_" + langshort] !== null &&
                StringResources["menu_call_" + langshort].length > 0) ||
              (typeof StringResources["btn_login_" + langshort] !==
                "undefined" &&
