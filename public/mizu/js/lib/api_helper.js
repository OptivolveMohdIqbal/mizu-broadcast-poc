...
try {
  ("undefined" == typeof webphone_api.parameters ||
    ...
    console &&
    console.log &&
    (window.__webphone_instance_count || (window.__webphone_instance_count = 0),
    window.__webphone_instance_count++,
    console.log(
      "EVENT, Loading webphone API " +
        window.__webphone_instance_count.toString() +
        "...",
    ));
} catch (e) {}
((webphone_api.helper = (function () {
    ...
    try {
      ...
      s = setInterval(function () {
        if (
          ++w > 1e4 ||
          (w > 1e4 &&
            (a(_) || _.length < 1 || !0 === webphone_api.webphone_loaded))
        )
          return (
            void 0 !== s && null !== s && clearInterval(s),
            (s = null),
            (_ = []),
            void (w = 0)
          );
        if (!(a(_) || _.length < 1) && !0 === webphone_api.webphone_loaded) {
          var e = _.shift();
          ...
          e.shift();
          var t = "";
          (webphone_api.common.isNull(e) || (t = e.toString()),
            webphone_api.Log(
  ...
  function i() {
    try {
      var n = new Date();
      if (void 0 !== n && null !== n) return n.getTime();
    } catch (e) {
      HLog("GetTickCount", e);
    }
    return 0;
  ...
  (webphone_api.setaudiodevice = function (n, p, o, i) {
    try {
      "undefined" != typeof webphone_api.plhandler &&
        null !== webphone_api.plhandler &&
        ((void 0 === n || null === n || n.length < 1) && (n = "-18"),
        (void 0 !== i && null !== i) || (i = 2),
        webphone_api.plhandler.SetDevice(i, n, p, o));
    } catch (e) {
  ...
  (webphone_api.onEventCb = function (n, p, o) {
    ...
    try {
      if (
        ...
        return;
      ((i = 11),
        (void 0 === n || null === n || n.length < 1) && (n = "log"),
        (i = 12),
        (void 0 !== p && null !== p) || (p = ""),
        (i = 13),
        (void 0 !== o && null !== o) || (o = ""),
      ...
      for (i = 2; a < webphone_api.eventcb.length;)
        if (
          ...
          i = 5;
          try {
            webphone_api.eventcb[a](n, p, o);
          } catch (e) {
            HLog("onEventCbInner " + n.toString() + " " + p + " " + o, e);
          }
          (a++, (i = 6));
        } else ((i = 4), webphone_api.eventcb.splice(a, 1));
    } catch (e) {
    ...
    try {
      if (
        ...
        "registered" == n
          ...
          : ("unregistered" != n && "failed" != n) ||
            (webphone_api.global.onregisteredcalled = !1),
  ...
  (webphone_api.onCallStateChangeCb = function (n, p, o, i, a, t) {
    ...
    try {
      if (
        ...
        r = 3;
        try {
          0 === webphone_api.global.nocallbackwarningdone &&
            ((webphone_api.global.nocallbackwarningdone = 1),
            webphone_api.Log(
      ...
      r = 4;
      for (var h = 0, l = 0; h < webphone_api.callstatechangecb.length;)
        if (
          ((r = 5),
          webphone_api.common.isNull(webphone_api.callstatechangecb[h]) ||
          ...
          ((r = 11),
            ++l,
            webphone_api.callstatechangecb[h](n, p, o, i, a, t),
            (r = 12),
            h++);
      if (l < 1)
        try {
  ...
  (webphone_api.onPresenceCb = function (n, p, o, i) {
    ...
    try {
      if (
        ...
        return;
      var t = 0;
      for (a = 2; t < webphone_api.presencecb.length;)
        ((a = 3),
          webphone_api.presencecb[t] &&
          "function" == typeof webphone_api.presencecb[t]
            ? ((a = 6),
              webphone_api.presencecb[t](n, p, o, i),
              (a = 7),
              t++,
              (a = 8))
            : ((a = 4), webphone_api.presencecb.splice(t, 1), (a = 5)));
    } catch (e) {
      HLog("onPresenceCb " + a.toString(), e);
    }
  }),
  (webphone_api.onBLFCb = function (n, p, o, i) {
    ...
    try {
      if (
        ...
        return;
      a = 2;
      for (var t = 0; t < webphone_api.blfcb.length;)
        ((a = 3),
          webphone_api.blfcb[t] && "function" == typeof webphone_api.blfcb[t]
            ? ((a = 5), webphone_api.blfcb[t](n, p, o, i), t++)
            : ((a = 4), webphone_api.blfcb.splice(t, 1)));
    } catch (e) {
      HLog("onBLFCb " + a.toString(), e);
    }
  }),
  (webphone_api.onCdrCb = function (n, p, o, i, a, t, r, h, l, b) {
    try {
      if (
        ...
        return;
      for (var _ = 0; _ < webphone_api.cdrcb.length;)
        webphone_api.cdrcb[_] && "function" == typeof webphone_api.cdrcb[_]
          ? (webphone_api.cdrcb[_](n, p, o, i, a, t, r, h, l, b), _++)
          : webphone_api.cdrcb.splice(_, 1);
    } catch (e) {
      HLog("onCdrCb", e);
    }
  }),
  ...
  (webphone_api.setmainfocus = function () {
    try {
      var n = document.getElementById("phone_number");
      webphone_api.common.isNull(n)
        ? webphone_api.Log("EVENT, setmainfocus not found")
        : (n.focus(), webphone_api.Log("EVENT, setmainfocus ok"));
    } catch (e) {
      HLog("setmainfocus", e);
    }
  }),
  ...
  (webphone_api.GetBrowserVersion = function () {
    try {
      var n = -1,
        p = webphone_api.GetBrowser(),
        o = navigator.userAgent.toLowerCase();
      if ("Chrome" === p) {
        var i = o.indexOf("chrome");
        (i > 0 && (o = o.substring(i + 6)),
          null != o && (o = o.replace("/", "")),
          (i = o.indexOf(".")),
          i > 0 && (o = o.substring(0, i)),
          null != o &&
            ((o = webphone_api.helper.Trim(o)),
            webphone_api.helper.IsNumber(o) &&
              (n = webphone_api.helper.StrToInt(o))));
      } else if ("Firefox" === p) {
        var i = o.indexOf("firefox");
        (i > 0 && (o = o.substring(i + 7)),
          webphone_api.helper.isNull(o) || (o = o.replace("/", "")),
          (i = o.indexOf(".")),
          i > 0 && (o = o.substring(0, i)),
          webphone_api.helper.isNull(o) ||
            ((o = webphone_api.helper.Trim(o)),
            webphone_api.helper.IsNumber(o) &&
              (n = webphone_api.helper.StrToInt(o))));
      } else if ("Safari" === p || "iPhone" === p) {
        var i = o.indexOf("version");
        (i > 0
          ? (o = o.substring(i + 7))
          : o.indexOf("_") > 0 &&
        ...
        var a = window.navigator.userAgent,
          t = a.indexOf("MSIE ");
        t > 0 && (n = parseInt(a.substring(t + 5, a.indexOf(".", t)), 10));
        var r = a.indexOf("Trident/");
        if (r > 0) {
          var h = a.indexOf("rv:");
          n = parseInt(a.substring(h + 3, a.indexOf(".", h)), 10);
        }
        var l = a.indexOf("Edge/");
        l > 0 && (n = parseInt(a.substring(l + 5, a.indexOf(".", l)), 10));
      } else if ("Edge" === p) {
        var i = o.indexOf("edge");
        (i > 0 && (o = o.substring(i + 4)),
          webphone_api.helper.isNull(o) || (o = o.replace("/", "")),
          (i = o.indexOf(".")),
          i > 0 && (o = o.substring(0, i)),
          webphone_api.helper.isNull(o) ||
      ...
      (!webphone_api.helper.isNull(n) && webphone_api.helper.IsNumber(n)) ||
        (n = -1);
    } catch (e) {
      HLog("GetBrowserversion", e);
    }
    return n;
  }),
      ...
      if (
        ...
        for (
          ...
          if (0 === i.indexOf(n)) {
            ...
            return (
              webphone_api.Log2("EVENT, apicookie read: " + e + "=" + a),
              a
            );
          }
        }
      ...
      if (res.indexOf("webphone_api.setparameter") >= 0) {
        ...
        return void (pos > 0
          ? ((param = res.substring(0, pos)),
            ...
            webphone_api.setparameter(param, value, !1))
          : webphone_api.Log(
...
((webphone_api.WebphoneSendMessageToParent = function (e) {
  ...
  (webphone_api.API_Register = function (e, n, p, o, i) {
    return (
      webphone_api.setparameter("serveraddress", e, !1),
      webphone_api.setparameter("sipusername", n, !1),
      webphone_api.setparameter("password", p, !1),
      webphone_api.setparameter("displayname", i, !1),
      webphone_api.start()
    );
  }),
  ...
  (webphone_api.API_GetLine = function () {
    return webphone_api.plhandler.API_GetLine();
  }),
  ...
  (webphone_api.API_Reject = function (e) {
    return webphone_api.reject(null, 2);
  }),
