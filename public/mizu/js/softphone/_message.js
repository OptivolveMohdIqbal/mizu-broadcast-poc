...
//                    ChooseChatOrSms(number, msg);
  ...
  function RemovePlaceHolder() {
    ...
    try {
      ...
      if (
        !webphone_api.common.isNull(mMessageTmp) &&
        mMessageTmp.indexOf(composePlaceHolder)
      ) {
  ...
  function SaveMissedIncomingMessage(action, from, name, msg) {
    try {
      ...
      var currfile =
        action + "_" + webphone_api.common.GetSipusername(true) + "_" + from;
