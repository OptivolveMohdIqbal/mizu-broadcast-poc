              ...
              if (!anychecked) {
                if (webphone_api.global.sipaccounts.length > 1) {
                  for (
                    ...
                    if (i !== idx) {
                      webphone_api.global.sipaccounts[i].enabled = true;
                      document.getElementById("acc_checkbox_" + i).checked =
                        true;
                      // reset ismain
                      for (
                        var j = 0;
    ...
    try {
      ...
      if (webphone_api.common.ShowServerInput() === true) {
        ...
        serverHtml =
          ...
          ":</label>" +
          '<input type="text" id="addacc_serveraddress" name="addacc_serveraddress" dir="auto" data-theme="a" autocapitalize="off" ' +
          val +
          ' placeholder="' +
          accounts_hint_server +
          '" />';
      ...
      var template =
        ...
        ":</label>" +
        '<input type="text" id="addacc_username" name="addacc_username" data-theme="a" dir="auto" autocapitalize="off" placeholder="' +
        accounts_hint_user +
        '" />' +
        ...
        '<input type="' +
        pwdinputtype +
        '" id="addacc_password" name="addacc_password" dir="auto" data-theme="a" autocapitalize="off" ' +
        autocompleteflag +
        ' placeholder="' +
        accounts_hint_password +
        '" />' +
        ...
        ":</label>" +
        '<input type="text" id="addacc_callerid" name="addacc_callerid" value="" dir="auto" data-theme="a" autocapitalize="off" placeholder="' +
        accounts_hint_callerid +
        '" />' +
        '<label for="addacc_displayname">' +
        webphone_api.stringres.get("sett_display_name_displayname") +
        ":</label>" +
        '<input type="text" id="addacc_displayname" name="addacc_displayname" value="" dir="auto" data-theme="a" autocapitalize="off" placeholder="' +
        accounts_hint_displayname +
        '" />' +
        '<label for="addacc_proxyaddress">' +
        webphone_api.stringres.get("sett_display_name_proxyaddress") +
        ":</label>" +
        '<input type="text" id="addacc_proxyaddress" name="addacc_proxyaddress" value="" dir="auto" data-theme="a" autocapitalize="off" placeholder="' +
        accounts_hint_proxy +
        '" />' +
        '<label for="addacc_realm">' +
        webphone_api.stringres.get("sett_display_name_realm") +
        ":</label>" +
        '<input type="text" id="addacc_realm" name="addacc_realm" value="" dir="auto" data-theme="a" autocapitalize="off" placeholder="' +
        accounts_hint_realm +
        '" />' +
        '<br /><label for="addacc_ival">' +
        webphone_api.stringres.get("addacc_ival") +
        ":</label>" +
        '<input type="text" id="addacc_ival" name="addacc_ival" value="3600" dir="auto" data-theme="a" autocapitalize="off" placeholder="' +
        accounts_hint_regival +
        '" />' +
        "</div>" +
        "</div>" +
