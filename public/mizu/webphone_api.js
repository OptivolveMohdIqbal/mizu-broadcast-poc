...
var webphone_api = (function () {
  ...
  function onAppStateChange(callback) {
    try {
      if (callback === null) {
        webphone_api.appstatechangecb = [];
        return true;
      }
      if (!callback || typeof callback !== "function") {
        return false;
      }
      for (var i = 0; i < webphone_api.appstatechangecb.length; i++) {
        if (webphone_api.appstatechangecb[i] === callback) {
          return false;
        }
      }
      ...
      LogEx("ERROR, WebPhoneAPI onAppStateChange: ", err);
    }
    return false;
  }
  ...
  function onRegStateChange(callback) {
    try {
      if (callback === null) {
        webphone_api.regstatechangecb = [];
        return true;
      }
      if (!callback || typeof callback !== "function") {
        return false;
      }
      for (var i = 0; i < webphone_api.regstatechangecb.length; i++) {
        if (webphone_api.regstatechangecb[i] === callback) {
          return false;
        }
      }
      ...
      LogEx("ERROR, WebPhoneAPI onRegStateChange: ", err);
    }
    return false;
  }
  ...
  function onCallStateChange(callback) {
    try {
      if (callback === null) {
        webphone_api.callstatechangecb = [];
        return true;
      }
      if (!callback || typeof callback !== "function") {
        return false;
      }
      for (var i = 0; i < webphone_api.callstatechangecb.length; i++) {
        if (webphone_api.callstatechangecb[i] === callback) {
          return false;
        }
      }
      ...
      LogEx("ERROR, WebPhoneAPI onCallStateChange: ", err);
    }
    return false;
  }
  /** Call this function once, passing a callback.
  ...
  function onChat(callback) {
    try {
      ...
      for (var i = 0; i < webphone_api.chatcb.length; i++) {
        if (webphone_api.chatcb[i] === callback) {
          return false;
        }
      }
      ...
      LogEx("ERROR, WebPhoneAPI onChat: ", err);
    }
    return false;
  }
  ...
  function onSMS(callback) {
    try {
      ...
      for (var i = 0; i < webphone_api.smscb.length; i++) {
        if (webphone_api.smscb[i] === callback) {
          return false;
        }
      }
      ...
      LogEx("ERROR, WebPhoneAPI onSMS: ", err);
    }
    return false;
  }
  ...
  function onCdr(callback) {
    try {
      ...
      for (var i = 0; i < webphone_api.cdrcb.length; i++) {
        if (webphone_api.cdrcb[i] === callback) {
          return false;
        }
      }
      ...
      LogEx("ERROR, WebPhoneAPI onCdr: ", err);
    }
    return false;
  }
  ...
  function onDTMF(callback) {
    try {
      ...
      for (var i = 0; i < webphone_api.cddtmf.length; i++) {
        if (webphone_api.cddtmf[i] === callback) {
          return false;
        }
      }
      ...
      LogEx("ERROR, WebPhoneAPI onDTMF: ", err);
    }
    return false;
  }
...
*/
   ...
   *  In some circumstances it can return the line directly. Othervise only via the callback. */
   ...
   * In some circumstances it can return the callid directly. Othervise only via the callback. */
  ...
  function onPresenceStateChange(callback) {
    try {
      if (callback === null) {
        webphone_api.presencecb = [];
        return true;
      }
      if (!callback || typeof callback !== "function") {
        return false;
      }
      for (var i = 0; i < webphone_api.presencecb.length; i++) {
        if (webphone_api.presencecb[i] === callback) {
          return false;
        }
      }
      ...
      LogEx("ERROR, WebPhoneAPI onPresenceStateChange: ", err);
    }
    return false;
  }
  ...
  function onBLFStateChange(callback) {
    try {
      ...
      for (var i = 0; i < webphone_api.blfcb.length; i++) {
        if (webphone_api.blfcb[i] === callback) {
          return false;
        }
      }
      ...
      LogEx("ERROR, WebPhoneAPI onBLFStateChange: ", err);
    }
    return false;
  }
...
*/
  ...
  function onEvent(callback) {
    try {
      ...
      // prevent duplicates
      for (var i = 0; i < webphone_api.eventcb.length; i++) {
        if (webphone_api.eventcb[i] === callback) {
          return false;
        }
      }
      ...
      LogEx("ERROR, WebPhoneAPI onEvent: ", err);
    }
    return false;
  }
  ...
  function onLoaded(callback) {
    try {
      ...
      for (var i = 0; i < webphone_api.loadedcb.length; i++) {
        if (webphone_api.loadedcb[i] === callback) {
          return false;
        }
      }
      ...
      LogEx("ERROR, WebPhoneAPI onLoaded: ", err);
    }
    return false;
  }
  ...
  function onStart(callback) {
    try {
      ...
      for (var i = 0; i < webphone_api.startcb.length; i++) {
        if (webphone_api.startcb[i] === callback) {
          return false;
        }
      }
      ...
      LogEx("ERROR, WebPhoneAPI onStart: ", err);
    }
    return false;
  }
  ...
  /** FCM/Firebase Push Notifications configuration: this is relevant only if you are using push notifications
   */
  var fcm_config = {
